...
export default function ConfirmModal({
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black/40 z-50 overlay-enter" onClick={handleClose} />

      {/* Modal card - positioned inline in the document flow so scrollIntoView works */}
      <div ref={overlayRef} className="fixed left-0 right-0 z-50 flex justify-center px-6 overlay-enter"
        style={{ top: '30vh' }}>
